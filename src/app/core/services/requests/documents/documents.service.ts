...
export class DocumentService {
  ...
  public getDocumentsList(
    ...
    return this._http
      .get(ENDPOINTS.documents.api, ENDPOINTS.documents.endpoints.pagination, {
        ...params,
      })
      .pipe(
        switchMap(
          (response: IResponse<IDocumentsList>): Observable<IDocumentsList> => {
  ...
  public addDocument(body: IReqeustDocumentCreate): Observable<IDocument> {
    return this._http
      .post(
        ENDPOINTS.documents.api,
        ENDPOINTS.documents.endpoints.create,
        {
          ...body,
        },
        {
  ...
  public searchDocument(
    ...
    return this._http
      .get(ENDPOINTS.documents.api, ENDPOINTS.documents.endpoints.search, {
        ...params,
      })
      .pipe(
        switchMap(
  ...
  public viewCount(id: string): Observable<IDocument> {
    return this._httpService
      .put(
        `${ENDPOINTS.documents.api}/${ENDPOINTS.documents.endpoints.view}/${id}`,
        null,
        {
          headers: {
